...
namespace winrt::AnimatedVisuals::implementation
{
            ...
            IClosable>
    {
        ...
        CompositionSpriteShape CreateSpriteShape(CompositionGeometry const& geometry, float3x2 const& transformMatrix, CompositionBrush const& fillBrush)
        {
            const auto result = _c.CreateSpriteShape(geometry);
            result.TransformMatrix(transformMatrix);
        ...
        CompositionSpriteShape SpriteShape_21()
        {
            ...
            const auto result = CreateSpriteShape(geometry, { 1.0F, 0.0F, 0.0F, 1.0F, 196.0F, 267.0F }, _colorBrush_White);;
            return result;
        }
        ...
        {
            // Offset:<196, 267>
            const auto geometry = _ellipse_4p7;
            const auto result = CreateSpriteShape(geometry, { 1.0F, 0.0F, 0.0F, 1.0F, 196.0F, 267.0F }, _colorBrush_White);;
            return result;
        }
