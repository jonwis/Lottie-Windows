...
//
//       LottieGen version:
//           7.1.2-build.25+g13ca7485f4
//       
//       Command:
//           LottieGen -Language Cppwinrt -WinUIVersion 2.4 -InputFile LottieLogo1.json
//       
//       Input file:
...
namespace winrt::AnimatedVisuals::implementation
{
            ...
            IClosable>
    {
        ...
        static void StartProgressBoundAnimation(
            ...
            std::wstring_view animatedPropertyName,
        ...
        void BindProperty(
            ...
            std::wstring_view referenceParameterName,
        ...
        Vector2KeyFrameAnimation CreateVector2KeyFrameAnimation(float initialProgress, float2 const& initialValue, CompositionEasingFunction initialEasingFunction)
        {
        ...
        CompositionSpriteShape CreateSpriteShape(CompositionGeometry geometry, float3x2 const& transformMatrix)
        {
        ...
        CompositionSpriteShape CreateSpriteShape(CompositionGeometry geometry, float3x2 const& transformMatrix, CompositionBrush fillBrush)
        {
            const auto result = _c.CreateSpriteShape(geometry);
            result.TransformMatrix(transformMatrix);
        ...
        winrt::com_ptr<CanvasGeometry> Geometry_00()
        {
            ...
            generate_figures(steps, sizeof(steps)/sizeof(steps[0]), both.sink.get());
            winrt::check_hresult(both.sink->Close());
            auto result = winrt::make_self<CanvasGeometry>(both.path);
            return result;
        }
            ...
            IClosable>
    {
        ...
        {
            // Offset:<187.5, 333.5>
            const auto geometry = RoundedRectangle_375x667();
            const auto result = CreateSpriteShape(geometry, { 1.0F, 0.0F, 0.0F, 1.0F, 187.5F, 333.5F }, ColorBrush_AlmostDarkTurquoise_FF00D1C1());;
            return result;
        }
        ...
        IInspectable& diagnostics)
    {
        ...
        {
            auto result = winrt::make<LottieLogo1_AnimatedVisual_UAPv12>(compositor);
            return result;
        }
        if (LottieLogo1_AnimatedVisual_UAPv7::IsRuntimeCompatible())
        {
            auto result = winrt::make<LottieLogo1_AnimatedVisual_UAPv7>(compositor);
            return result;
        }
